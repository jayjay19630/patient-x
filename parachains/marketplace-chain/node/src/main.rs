...
//!
//! This is the collator node for the Marketplace parachain,
//! managing health records, IPFS integration, and encryption for the Patient X platform.
...
impl SubstrateCli for Cli {
    ...
    fn support_url() -> String {
        "https://github.com/patient-x/marketplace-chain/issues".into()
    }

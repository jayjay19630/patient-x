...
//!
//! This runtime implements the Marketplace parachain for the Patient X medical data marketplace.
//! It manages data listings, purchases, reputation, and analytics.
//!
//! ## Architecture Reference
//! See ../README.md Section: "Marketplace Chain"
//!
//! Para ID: 2002
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("marketplace-chain"),
    impl_name: create_runtime_str!("marketplace-chain"),
    authoring_version: 1,
    spec_version: 1,
    impl_version: 1,
...
parameter_types! {
    pub const MaxListingsPerProvider: u32 = 100;
}
...
parameter_types! {
    pub const PlatformFeePercent: u8 = 5; // 5% platform fee
}
...
parameter_types! {
    pub const MaxReviewsPerUser: u32 = 500;
}
...
impl pallet_analytics::Config for Runtime {
    type RuntimeEvent = RuntimeEvent;
    type TimeProvider = Timestamp;
}
...
construct_runtime!(
    pub enum Runtime
    {
        ...
        // Custom pallets
        DataListings: pallet_data_listings = 50,
        Marketplace: pallet_marketplace = 51,
        Reputation: pallet_reputation = 52,
        Analytics: pallet_analytics = 53,
    }
);

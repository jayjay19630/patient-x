//! HealthData Chain Node
//!
//! This is the collator node for the HealthData parachain,
...
impl SubstrateCli for Cli {
    ...
    fn support_url() -> String {
        "https://github.com/patient-x/health-data-chain/issues".into()
    }

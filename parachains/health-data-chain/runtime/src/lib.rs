//! # HealthData Chain Runtime
//!
//! This runtime implements the HealthData parachain for the Patient X medical data marketplace.
//! It manages encrypted health records, IPFS integration, access control, and encryption keys.
//!
//! ## Architecture Reference
//! See ../README.md Section: "HealthData Chain"
//!
//! Para ID: 2001
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("health-data-chain"),
    impl_name: create_runtime_str!("health-data-chain"),
    authoring_version: 1,
    spec_version: 1,
    impl_version: 1,
...
impl pallet_health_records::Config for Runtime {
    type RuntimeEvent = RuntimeEvent;
    type TimeProvider = Timestamp;
}

parameter_types! {
    pub const MaxIPFSNodes: u32 = 100;
}

impl pallet_ipfs_integration::Config for Runtime {
    type RuntimeEvent = RuntimeEvent;
    type TimeProvider = Timestamp;
    type MaxIPFSNodes = MaxIPFSNodes;
}
...
parameter_types! {
    pub const MaxKeysPerAccount: u32 = 100;
    pub const MaxAccessGrantsPerKey: u32 = 50;
}

impl pallet_encryption::Config for Runtime {
    type RuntimeEvent = RuntimeEvent;
    type TimeProvider = Timestamp;
    type MaxKeysPerAccount = MaxKeysPerAccount;
    type MaxAccessGrantsPerKey = MaxAccessGrantsPerKey;
}
...
construct_runtime!(
    pub enum Runtime
    {
        ...
        // Custom pallets
        HealthRecords: pallet_health_records = 50,
        IPFSIntegration: pallet_ipfs_integration = 51,
        AccessControl: pallet_access_control = 52,
        Encryption: pallet_encryption = 53,
    }
);

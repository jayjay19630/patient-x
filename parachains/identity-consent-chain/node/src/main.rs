//! IdentityConsent Chain Node
//!
//! This is the collator node for the IdentityConsent parachain,
//! managing identity, consent, and authentication for the Patient X platform.
...
use identity_consent_runtime::Block;
use polkadot_cli::{RelayChainCli, RuntimeApiCollection};
use sc_cli::{
...
impl SubstrateCli for Cli {
    ...
    fn support_url() -> String {
        "https://github.com/patient-x/identity-consent-chain/issues".into()
    }
...
pub enum Subcommand {
    ...
    #[command(alias = "export-genesis-head")]
    ...
    match &cli.subcommand {
        ...
        None => {
            ...
            runner.run_node_until_exit(|config| async move {
                let hwbench = (!cli.run.no_hardware_benchmarks).then_some(
